    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        >
          ...
          {/* ─────────────────────────────────────────────────────────────────
              📅 Teacher Attendance
              FIX: Dono routes mein [P.MARK_TEACHER_ATTENDANCE, P.VIEW_ONE_TEACHER_ATTENDANCE]
              array diya hai — OR condition.
              Abhi backend me sirf view_one_teacher_attendance hai token mein,
              isliye wo kaam karega. Jab backend mark_teacher_attendance add
              karega tab wo bhi automatically kaam karega.
              ───────────────────────────────────────────────────────────────── */}
          <Route path="teacher-attendance" element={
            <ProtectedRoute permission={[P.MARK_TEACHER_ATTENDANCE, P.VIEW_ONE_TEACHER_ATTENDANCE]}>
              <MarkTeacherAttendance />
            </ProtectedRoute>
          }/>
          <Route path="teacher-attendance/list" element={
            <ProtectedRoute permission={[P.VIEW_ONE_TEACHER_ATTENDANCE, P.MARK_TEACHER_ATTENDANCE]}>
              <TeacherAttendanceList />
            </ProtectedRoute>
          }/>
          <Route path="teacher-attendance/report" element={
          ...
          {/* ─────────────────────────────────────────────────────────────────
              📝 Exams
              FIX: Har route mein [specific_permission, P.MANAGE_EXAM_MARKS]
              array diya — OR condition.
              manage_exam_marks backend me hai token mein — fallback kaam karega.
              Jab backend getExams API fix hogi tab actual pages load honge.
              ───────────────────────────────────────────────────────────────── */}
          <Route path="exams" element={
            <ProtectedRoute permission={[P.VIEW_EXAM, P.MANAGE_EXAM_MARKS]}>
              <ExamList />
