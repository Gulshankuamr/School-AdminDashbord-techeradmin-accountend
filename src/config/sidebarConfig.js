...
export const sidebarMenuItems = [
    ...
    items: [
      {
        ...
        icon:        FileText,
        hasDropdown: true,
        // MANAGE_EXAM_MARKS pehle rakha — backend me ye hai, baaki fallback
        permission: [
          P.MANAGE_EXAM_MARKS,
          P.CREATE_EXAM,
          P.VIEW_EXAM,
        ...
        subItems: [
          {
            ...
            label:      'Create Exam',
            path:       '/admin/exams/add',
            // CREATE_EXAM backend me nahi — MANAGE_EXAM_MARKS se fallback
            permission: [P.CREATE_EXAM, P.MANAGE_EXAM_MARKS],
          },
          {
            id:         'view-exams',
            label:      'View Exams',
            path:       '/admin/exams',
            permission: [P.VIEW_EXAM, P.MANAGE_EXAM_MARKS],
          },
          {
            id:         'exam-timetable-create',
            label:      'Create Exam Timetable',
            path:       '/admin/exams/timetable/create',
            permission: [P.CREATE_EXAM_TIMETABLE, P.MANAGE_EXAM_MARKS],
          },
          {
            id:         'exam-timetable-view',
            label:      'View Exam Timetable',
            path:       '/admin/exams/timetable',
            permission: [P.VIEW_EXAM_TIMETABLE, P.MANAGE_EXAM_MARKS],
          },
          {
            id:         'assign-marks',
            label:      'Scholastic Marks',
            path:       '/admin/exams/assign-marks',
            permission: [P.ASSIGN_MARKS, P.MANAGE_EXAM_MARKS],
          },
          {
            id:         'marks-list',
            label:      'Scholastic Marks List',
            path:       '/admin/exams/marks-list',
            permission: [P.VIEW_MARKS, P.MANAGE_EXAM_MARKS],
          },
          {
            id:         'co-scholastic-grades',
            label:      'Co-Scholastic Grades',
            path:       '/admin/exams/co-scholastic',
            permission: [P.MANAGE_CO_SCHOLASTIC, P.MANAGE_EXAM_MARKS],
          },
          {
            id:         'marksheet-generator',
            label:      'Generate Marksheet',
            path:       '/admin/exams/marksheet-generator',
            permission: [P.GENERATE_MARKSHEET, P.MANAGE_EXAM_MARKS],
          },
          {
            id:         'generate-admit-card',
            label:      'Admit & ID Cards',
            path:       '/admin/exams/admit-card',
            permission: [P.GENERATE_ADMIT_CARD, P.MANAGE_EXAM_MARKS],
          },
        ],
      },
    ],
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  {
    ...
    items: [
      ...
      // ─── TEACHER ATTENDANCE ───────────────────────────────────────────────
      // Group dikhega agar VIEW_ONE_TEACHER_ATTENDANCE ho (backend me hai)
      // Mark Attendance: MARK_TEACHER_ATTENDANCE (backend me nahi abhi) ya VIEW_ONE_TEACHER_ATTENDANCE
      // Attendance List: VIEW_ONE_TEACHER_ATTENDANCE
      // ─────────────────────────────────────────────────────────────────────
      {
        id:          'teacher-attendance',
        label:       'Teacher Attendance',
        icon:        BookUser,
        hasDropdown: true,
        permission:  [P.MARK_TEACHER_ATTENDANCE, P.VIEW_ONE_TEACHER_ATTENDANCE],
        subItems: [
          {
            id:         'mark-teacher-attendance',
            label:      'Mark Attendance',
            path:       '/admin/teacher-attendance',
            // Fallback: agar mark_teacher_attendance nahi to view_one_teacher_attendance se dikhao
            permission: [P.MARK_TEACHER_ATTENDANCE, P.VIEW_ONE_TEACHER_ATTENDANCE],
          },
          {
            id:         'teacher-attendance-list',
            label:      'Attendance List',
            path:       '/admin/teacher-attendance/list',
            permission: [P.VIEW_ONE_TEACHER_ATTENDANCE, P.MARK_TEACHER_ATTENDANCE],
          },
        ],
      },
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  {
    ...
    color:   'orange',
    items: [
      { id: 'transport-routes',  label: 'Routes Management', icon: Bus,       path: '/admin/transport/routes',          permission: P.MANAGE_TRANSPORT },
      { id: 'transport-stops',   label: 'Stops Management',  icon: MapPin,    path: '/admin/transport/stops',           permission: P.MANAGE_TRANSPORT },
      { id: 'assign-transport',  label: 'Assign Transport',  icon: UserCheck, path: '/admin/transport/assign-student',  permission: P.MANAGE_TRANSPORT },
    ],
  },
